...
@utils.arg('--no-sys-vol', dest='no_sys_vol', action='store_true', default=False, help=_('Migrate the system volume as well or not.'))
@utils.arg('--poll',
    dest='poll',
    action="store_true",
    default=False,
...
def do_migrate(cs, args):
    ...
    server = _find_server(cs, args.server)
    server.migrate(args.availability_zone, args.no_sys_vol)
