    ...
    def create(self, req, body):
        ...
        if snapshot_id is not None:
            '''try:
                ...
                raise exc.HTTPNotFound(explanation=explanation)'''
            vol_size = volume.get('size', None)
            kwargs['snapshot'] = {'id': snapshot_id,'status':'available','volume_size':vol_size,'volume_type_id':None}
        else:
        ...
        shareable = volume.get('shareable', False)
        kwargs['shareable'] = shareable
