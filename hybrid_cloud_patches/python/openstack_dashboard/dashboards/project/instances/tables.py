...
class Migrate(policy.PolicyTargetMixin, tables.LinkAction):
    name = "migrate"
    verbose_name = _("Migrate Instance")
    url = "horizon:project:instances:migrate"
    classes = ("ajax-modal",)
    icon = "camera"
...
class InstancesTable(tables.DataTable):
    ...
    class Meta:
        ...
        row_actions = (StartInstance, ConfirmResize, RevertResize,
                       ...
                       SimpleDisassociateIP, EditInstance, Migrate,
